...
void protobuf_AddDesc_attribute_5ftypes_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\025attribute_types.proto\022\tBattlenet\032\022enti"
    "ty_types.proto\"\336\001\n\007Variant\022\022\n\nbool_value"
    "\030\002 \001(\010\022\021\n\tint_value\030\003 \001(\003\022\023\n\013float_value"
    "\030\004 \001(\001\022\024\n\014string_value\030\005 \001(\t\022\022\n\nblob_val"
    "ue\030\006 \001(\014\022\025\n\rmessage_value\030\007 \001(\014\022\024\n\014fourc"
    "c_value\030\010 \001(\t\022\022\n\nuint_value\030\t \001(\004\022,\n\017ent"
    "ity_id_value\030\n \001(\0132\023.Battlenet.EntityId\""
    "<\n\tAttribute\022\014\n\004name\030\001 \002(\t\022!\n\005value\030\002 \002("
    "\0132\022.Battlenet.Variant\"\304\001\n\017AttributeFilte"
    "r\0220\n\002op\030\001 \002(\0162$.Battlenet.AttributeFilte"
    "r.Operation\022\'\n\tattribute\030\002 \003(\0132\024.Battlen"
    "et.Attribute\"V\n\tOperation\022\016\n\nMATCH_NONE\020"
    "\000\022\r\n\tMATCH_ANY\020\001\022\r\n\tMATCH_ALL\020\002\022\033\n\027MATCH"
    "_ALL_MOST_SPECIFIC\020\003B\002H\001", 544);
...
Variant::Variant()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:Battlenet.Variant)
}

void Variant::InitAsDefaultInstance() {
  entity_id_value_ = const_cast< ::Battlenet::EntityId*>(&::Battlenet::EntityId::default_instance());
}
...
Variant::Variant(const Variant& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:Battlenet.Variant)
}
...
Variant::~Variant() {
  // @@protoc_insertion_point(destructor:Battlenet.Variant)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:Battlenet.Variant)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:Battlenet.Variant)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:Battlenet.Variant)
  return false;
#undef DO_
}
...
void Variant::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:Battlenet.Variant)
  // optional bool bool_value = 2;
  if (has_bool_value()) {
  ...
  // @@protoc_insertion_point(serialize_end:Battlenet.Variant)
}

::google::protobuf::uint8* Variant::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:Battlenet.Variant)
  // optional bool bool_value = 2;
  if (has_bool_value()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Battlenet.Variant)
  return target;
}
...
void Variant::MergeFrom(const Variant& from) {
  ...
  if (from._has_bits_[8 / 32] & (0xffu << (8 % 32))) {
    if (from.has_entity_id_value()) {
      mutable_entity_id_value()->::Battlenet::EntityId::MergeFrom(from.entity_id_value());
    }
  }
...
Attribute::Attribute()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:Battlenet.Attribute)
}
...
Attribute::Attribute(const Attribute& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:Battlenet.Attribute)
}
...
Attribute::~Attribute() {
  // @@protoc_insertion_point(destructor:Battlenet.Attribute)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:Battlenet.Attribute)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:Battlenet.Attribute)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:Battlenet.Attribute)
  return false;
#undef DO_
}
...
void Attribute::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:Battlenet.Attribute)
  // required string name = 1;
  if (has_name()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->name().data(), this->name().length(),
  ...
  // @@protoc_insertion_point(serialize_end:Battlenet.Attribute)
}

::google::protobuf::uint8* Attribute::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:Battlenet.Attribute)
  // required string name = 1;
  if (has_name()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->name().data(), this->name().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Battlenet.Attribute)
  return target;
}
...
AttributeFilter::AttributeFilter()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:Battlenet.AttributeFilter)
}
...
AttributeFilter::AttributeFilter(const AttributeFilter& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:Battlenet.AttributeFilter)
}
...
AttributeFilter::~AttributeFilter() {
  // @@protoc_insertion_point(destructor:Battlenet.AttributeFilter)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:Battlenet.AttributeFilter)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
      ...
      case 1: {
        if (tag == 8) {
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::Battlenet::AttributeFilter_Operation_IsValid(value)) {
            set_op(static_cast< ::Battlenet::AttributeFilter_Operation >(value));
          } else {
...
success:
  // @@protoc_insertion_point(parse_success:Battlenet.AttributeFilter)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:Battlenet.AttributeFilter)
  return false;
#undef DO_
}
...
void AttributeFilter::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:Battlenet.AttributeFilter)
  // required .Battlenet.AttributeFilter.Operation op = 1;
  if (has_op()) {
  ...
  // @@protoc_insertion_point(serialize_end:Battlenet.AttributeFilter)
}

::google::protobuf::uint8* AttributeFilter::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:Battlenet.AttributeFilter)
  // required .Battlenet.AttributeFilter.Operation op = 1;
  if (has_op()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Battlenet.AttributeFilter)
  return target;
}
