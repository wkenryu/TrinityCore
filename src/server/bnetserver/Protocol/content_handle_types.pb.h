...
class ContentHandle : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:Battlenet.ContentHandle)
 private:
...
inline ::google::protobuf::uint32 ContentHandle::region() const {
  // @@protoc_insertion_point(field_get:Battlenet.ContentHandle.region)
  return region_;
}
inline void ContentHandle::set_region(::google::protobuf::uint32 value) {
  set_has_region();
  region_ = value;
  // @@protoc_insertion_point(field_set:Battlenet.ContentHandle.region)
}
...
inline ::google::protobuf::uint32 ContentHandle::usage() const {
  // @@protoc_insertion_point(field_get:Battlenet.ContentHandle.usage)
  return usage_;
}
inline void ContentHandle::set_usage(::google::protobuf::uint32 value) {
  set_has_usage();
  usage_ = value;
  // @@protoc_insertion_point(field_set:Battlenet.ContentHandle.usage)
}
...
inline const ::std::string& ContentHandle::hash() const {
  // @@protoc_insertion_point(field_get:Battlenet.ContentHandle.hash)
  return *hash_;
}
inline void ContentHandle::set_hash(const ::std::string& value) {
  ...
  hash_->assign(value);
  // @@protoc_insertion_point(field_set:Battlenet.ContentHandle.hash)
}
inline void ContentHandle::set_hash(const char* value) {
  ...
  hash_->assign(value);
  // @@protoc_insertion_point(field_set_char:Battlenet.ContentHandle.hash)
}
inline void ContentHandle::set_hash(const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:Battlenet.ContentHandle.hash)
}
inline ::std::string* ContentHandle::mutable_hash() {
  ...
  // @@protoc_insertion_point(field_mutable:Battlenet.ContentHandle.hash)
  return hash_;
}
...
inline void ContentHandle::set_allocated_hash(::std::string* hash) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Battlenet.ContentHandle.hash)
}
...
inline const ::std::string& ContentHandle::proto_url() const {
  // @@protoc_insertion_point(field_get:Battlenet.ContentHandle.proto_url)
  return *proto_url_;
}
inline void ContentHandle::set_proto_url(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:Battlenet.ContentHandle.proto_url)
}
inline void ContentHandle::set_proto_url(const char* value) {
  ...
  proto_url_->assign(value);
  // @@protoc_insertion_point(field_set_char:Battlenet.ContentHandle.proto_url)
}
inline void ContentHandle::set_proto_url(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:Battlenet.ContentHandle.proto_url)
}
inline ::std::string* ContentHandle::mutable_proto_url() {
  ...
  // @@protoc_insertion_point(field_mutable:Battlenet.ContentHandle.proto_url)
  return proto_url_;
}
...
inline void ContentHandle::set_allocated_proto_url(::std::string* proto_url) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Battlenet.ContentHandle.proto_url)
}
