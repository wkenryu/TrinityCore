...
void protobuf_AddDesc_role_5ftypes_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "removable_role\030\n \003(\rB\002\020\001B\002H\001", 308);
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:Battlenet.Role)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:Battlenet.Role)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:Battlenet.Role)
  return false;
#undef DO_
}
...
void Role::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:Battlenet.Role)
  // required uint32 id = 1;
  if (has_id()) {
  ...
  // @@protoc_insertion_point(serialize_end:Battlenet.Role)
}

::google::protobuf::uint8* Role::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:Battlenet.Role)
  // required uint32 id = 1;
  if (has_id()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Battlenet.Role)
  return target;
}
