...
void protobuf_AddDesc_content_5fhandle_5ftypes_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\032content_handle_types.proto\022\tBattlenet\""
    "O\n\rContentHandle\022\016\n\006region\030\001 \002(\007\022\r\n\005usag"
    "e\030\002 \002(\007\022\014\n\004hash\030\003 \002(\014\022\021\n\tproto_url\030\004 \001(\t"
    "B\002H\001", 124);
...
ContentHandle::ContentHandle()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:Battlenet.ContentHandle)
}
...
ContentHandle::ContentHandle(const ContentHandle& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:Battlenet.ContentHandle)
}
...
ContentHandle::~ContentHandle() {
  // @@protoc_insertion_point(destructor:Battlenet.ContentHandle)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:Battlenet.ContentHandle)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:Battlenet.ContentHandle)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:Battlenet.ContentHandle)
  return false;
#undef DO_
}
...
void ContentHandle::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:Battlenet.ContentHandle)
  // required fixed32 region = 1;
  if (has_region()) {
  ...
  // @@protoc_insertion_point(serialize_end:Battlenet.ContentHandle)
}

::google::protobuf::uint8* ContentHandle::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:Battlenet.ContentHandle)
  // required fixed32 region = 1;
  if (has_region()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Battlenet.ContentHandle)
  return target;
}
