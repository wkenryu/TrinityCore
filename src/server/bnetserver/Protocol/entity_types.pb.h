...
class EntityId : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:Battlenet.EntityId)
 private:
...
class Identity : public ::google::protobuf::Message {
 public:
  ...
  // optional .Battlenet.EntityId account_id = 1;
  ...
  // @@protoc_insertion_point(class_scope:Battlenet.Identity)
 private:
...
class AccountInfo : public ::google::protobuf::Message {
 public:
  ...
  // optional .Battlenet.Identity identity = 5;
  ...
  // @@protoc_insertion_point(class_scope:Battlenet.AccountInfo)
 private:
...
inline ::google::protobuf::uint64 EntityId::high() const {
  // @@protoc_insertion_point(field_get:Battlenet.EntityId.high)
  return high_;
}
inline void EntityId::set_high(::google::protobuf::uint64 value) {
  set_has_high();
  high_ = value;
  // @@protoc_insertion_point(field_set:Battlenet.EntityId.high)
}
...
inline ::google::protobuf::uint64 EntityId::low() const {
  // @@protoc_insertion_point(field_get:Battlenet.EntityId.low)
  return low_;
}
inline void EntityId::set_low(::google::protobuf::uint64 value) {
  set_has_low();
  low_ = value;
  // @@protoc_insertion_point(field_set:Battlenet.EntityId.low)
}
...
inline const ::Battlenet::EntityId& Identity::account_id() const {
  // @@protoc_insertion_point(field_get:Battlenet.Identity.account_id)
  return account_id_ != NULL ? *account_id_ : *default_instance_->account_id_;
}
inline ::Battlenet::EntityId* Identity::mutable_account_id() {
  set_has_account_id();
  if (account_id_ == NULL) account_id_ = new ::Battlenet::EntityId;
  // @@protoc_insertion_point(field_mutable:Battlenet.Identity.account_id)
  return account_id_;
}
inline ::Battlenet::EntityId* Identity::release_account_id() {
  clear_has_account_id();
  ::Battlenet::EntityId* temp = account_id_;
  account_id_ = NULL;
  return temp;
}
inline void Identity::set_allocated_account_id(::Battlenet::EntityId* account_id) {
  delete account_id_;
  ...
  // @@protoc_insertion_point(field_set_allocated:Battlenet.Identity.account_id)
}
...
inline const ::Battlenet::EntityId& Identity::game_account_id() const {
  // @@protoc_insertion_point(field_get:Battlenet.Identity.game_account_id)
  return game_account_id_ != NULL ? *game_account_id_ : *default_instance_->game_account_id_;
}
inline ::Battlenet::EntityId* Identity::mutable_game_account_id() {
  set_has_game_account_id();
  if (game_account_id_ == NULL) game_account_id_ = new ::Battlenet::EntityId;
  // @@protoc_insertion_point(field_mutable:Battlenet.Identity.game_account_id)
  return game_account_id_;
}
inline ::Battlenet::EntityId* Identity::release_game_account_id() {
  clear_has_game_account_id();
  ::Battlenet::EntityId* temp = game_account_id_;
  game_account_id_ = NULL;
  return temp;
}
inline void Identity::set_allocated_game_account_id(::Battlenet::EntityId* game_account_id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Battlenet.Identity.game_account_id)
}
...
inline bool AccountInfo::account_paid() const {
  // @@protoc_insertion_point(field_get:Battlenet.AccountInfo.account_paid)
  return account_paid_;
}
inline void AccountInfo::set_account_paid(bool value) {
  set_has_account_paid();
  account_paid_ = value;
  // @@protoc_insertion_point(field_set:Battlenet.AccountInfo.account_paid)
}
...
inline ::google::protobuf::uint32 AccountInfo::country_id() const {
  // @@protoc_insertion_point(field_get:Battlenet.AccountInfo.country_id)
  return country_id_;
}
inline void AccountInfo::set_country_id(::google::protobuf::uint32 value) {
  set_has_country_id();
  country_id_ = value;
  // @@protoc_insertion_point(field_set:Battlenet.AccountInfo.country_id)
}
...
inline const ::std::string& AccountInfo::battle_tag() const {
  // @@protoc_insertion_point(field_get:Battlenet.AccountInfo.battle_tag)
  return *battle_tag_;
}
inline void AccountInfo::set_battle_tag(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:Battlenet.AccountInfo.battle_tag)
}
inline void AccountInfo::set_battle_tag(const char* value) {
  ...
  battle_tag_->assign(value);
  // @@protoc_insertion_point(field_set_char:Battlenet.AccountInfo.battle_tag)
}
inline void AccountInfo::set_battle_tag(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:Battlenet.AccountInfo.battle_tag)
}
inline ::std::string* AccountInfo::mutable_battle_tag() {
  ...
  // @@protoc_insertion_point(field_mutable:Battlenet.AccountInfo.battle_tag)
  return battle_tag_;
}
...
inline void AccountInfo::set_allocated_battle_tag(::std::string* battle_tag) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Battlenet.AccountInfo.battle_tag)
}
...
inline bool AccountInfo::manual_review() const {
  // @@protoc_insertion_point(field_get:Battlenet.AccountInfo.manual_review)
  return manual_review_;
}
inline void AccountInfo::set_manual_review(bool value) {
  set_has_manual_review();
  manual_review_ = value;
  // @@protoc_insertion_point(field_set:Battlenet.AccountInfo.manual_review)
}
...
inline const ::Battlenet::Identity& AccountInfo::identity() const {
  // @@protoc_insertion_point(field_get:Battlenet.AccountInfo.identity)
  return identity_ != NULL ? *identity_ : *default_instance_->identity_;
}
inline ::Battlenet::Identity* AccountInfo::mutable_identity() {
  set_has_identity();
  if (identity_ == NULL) identity_ = new ::Battlenet::Identity;
  // @@protoc_insertion_point(field_mutable:Battlenet.AccountInfo.identity)
  return identity_;
}
inline ::Battlenet::Identity* AccountInfo::release_identity() {
  clear_has_identity();
  ::Battlenet::Identity* temp = identity_;
  identity_ = NULL;
  return temp;
}
inline void AccountInfo::set_allocated_identity(::Battlenet::Identity* identity) {
  delete identity_;
  identity_ = identity;
  if (identity) {
    set_has_identity();
  ...
  // @@protoc_insertion_point(field_set_allocated:Battlenet.AccountInfo.identity)
}
...
inline bool AccountInfo::account_muted() const {
  // @@protoc_insertion_point(field_get:Battlenet.AccountInfo.account_muted)
  return account_muted_;
}
inline void AccountInfo::set_account_muted(bool value) {
  set_has_account_muted();
  account_muted_ = value;
  // @@protoc_insertion_point(field_set:Battlenet.AccountInfo.account_muted)
}
