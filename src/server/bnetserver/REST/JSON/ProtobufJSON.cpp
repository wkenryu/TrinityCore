...
std::string Battlenet::JSON::Serialize(google::protobuf::Message const& message)
{
...
bool Battlenet::JSON::Deserialize(std::string json, google::protobuf::Message* message)
{
